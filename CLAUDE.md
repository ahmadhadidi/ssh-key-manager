...
| `menu.ps1` | ~280 | Menu dispatcher and all menu case handlers | `Invoke-MenuChoice`:5 |
...
- `Invoke-MenuChoice`:5 — dispatcher; 18-case switch, each case handles one menu operation inline
