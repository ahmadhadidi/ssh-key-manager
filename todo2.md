...
Right now when I "List Authorized Keys on Remote Host" and it opens a connection, the padding is not respected and it looks off-kilter, here's an example:
  ...
  Remote username:  testuser
  Fetching authorized_keys from testuser@192.168.0.204...
testuser@192.168.0.204's password:
...
When I quit the application by pressing "Q" the app does not properly clean itsself, here's how it looks like (notice "testuser@dev-poc:/proj/ssh-key-manager$"):

  ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                                                                                            🌊 HDD SSH Keys Manager                                                                                                                             testuser@dev-poc:/proj/ssh-key-manager$
...
ssh-ed25519 abcabc new-lan-[HO5]
  +  /home/testuser/.ssh/new-lan  imported.
  +  /home/testuser/.ssh/new-lan.pub  imported.
...
Want more proof? Here's a listing of "View SSH Config":
  ...
  Host axc
    ...
    User testuser
    IdentityFile /home/testuser/.ssh/demo-lan
    IdentityFile /home/testuser/.ssh/dev-lan
  ...
  Host 192.168.0.210
    ...
    User testuser
    IdentityFile /home/testuser/.ssh/dev-lan
    IdentityFile /home/testuser/.ssh/new-lan
